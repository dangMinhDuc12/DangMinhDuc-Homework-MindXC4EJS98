...
//15.5
// let a = jobData.hits[0].benefits;
// console.log('First job benefits');
// for (let i = 0; i < a.length; i++ ){
    
//     console.log(a[i].benefitValue);
// }
...
//     let j = jobData.hits[i].benefits;
//     for (let m = 0; m < j.length; m++){
//         console.log(j[m].benefitValue);
...
// jobData.hits[0].jobSalary
// jobData.hits[0].locations[i]
// jobData.hits[0].benefits[i]
// jobData.hits[0].skills[i]

// for (let i = 0; i < jobData.hits.length; i++){
//     console.log(`Title ${jobData.hits[i].jobTitle}`);
//     console.log(`Salary ${jobData.hits[i].jobSalary}`);
//     for (let b = 0; b < jobData.hits[i].locations.length; b++){
//         console.log(`Locations : ${jobData.hits[i].locations[b]}`);
//     }
//     console.log(`Benefits Value:`);
//     for (let c = 0; c < jobData.hits[i].benefits.length; c++){
        

//         console.log(` ${jobData.hits[i].benefits[c].benefitValue}`);
//     }
//     console.log(`Skills:`);
//     for (let d = 0; d < jobData.hits[i].skills.length; d++){
        
//         console.log(` ${jobData.hits[i].skills[d]}`);
//     }
//     console.log(`----------------------------`);
// }
