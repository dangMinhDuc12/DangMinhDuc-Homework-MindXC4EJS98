...
// //1.1 x sẽ trả về property của obj
// //1.2
// for (let x in product){
...
// 3.1 Kiểu dữ liệu ngoài cùng là kiểu dữ liệu đối tượng
// 3.2 Property hits là một mảng có 6 phần tử
// 3.3 Đầu tiên ta đi vào bên trong mảng hits gồm có 6 phần tử, mỗi một phần tử trong mảng hits lại là một object và trong các object đó có các property là job’s title, locations, salary, benefits, skills và requirements
